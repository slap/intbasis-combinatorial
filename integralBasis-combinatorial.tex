...
\STATE Define $C = \{(c_1, \dots, c_m) \in \Z_{\ge 0}^m : c_1 d_1  + \dots c_m d_m = d\}$, the set of all the possible $m$-tuples.
...
\begin{algorithm}[h]                      % enter the algorithm environment
\caption{\texttt{IntegralBasisTterative}}          % give the algorithm a caption
